...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NHACUNGCAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NHACUNGCAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NHACUNGCAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NHACUNGCAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NHACUNGCAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NHACUNGCAP actions', async () => {
      const arg = 42666;
