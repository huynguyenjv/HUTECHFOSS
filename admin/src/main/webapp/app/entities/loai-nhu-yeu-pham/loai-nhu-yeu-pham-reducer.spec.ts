...
import reducer, {
  ...
  reset,
  updateEntity,
} from './loai-nhu-yeu-pham.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOAINHUYEUPHAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOAINHUYEUPHAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOAINHUYEUPHAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOAINHUYEUPHAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOAINHUYEUPHAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOAINHUYEUPHAM actions', async () => {
      const arg = 42666;
