...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TINHNGUYENVIEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TINHNGUYENVIEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TINHNGUYENVIEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TINHNGUYENVIEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TINHNGUYENVIEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TINHNGUYENVIEN actions', async () => {
      const arg = 42666;
