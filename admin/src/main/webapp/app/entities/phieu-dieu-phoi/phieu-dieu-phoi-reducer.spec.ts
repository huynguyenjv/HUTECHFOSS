...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHIEUDIEUPHOI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHIEUDIEUPHOI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHIEUDIEUPHOI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PHIEUDIEUPHOI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PHIEUDIEUPHOI actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PHIEUDIEUPHOI actions', async () => {
      const arg = 42666;
