...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NHUYEUPHAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NHUYEUPHAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NHUYEUPHAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NHUYEUPHAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NHUYEUPHAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NHUYEUPHAM actions', async () => {
      const arg = 42666;
