...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOAINGUOINHAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOAINGUOINHAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOAINGUOINHAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOAINGUOINHAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOAINGUOINHAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOAINGUOINHAN actions', async () => {
      const arg = 42666;
