...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOAITHIENTAI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOAITHIENTAI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOAITHIENTAI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOAITHIENTAI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOAITHIENTAI actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOAITHIENTAI actions', async () => {
      const arg = 42666;
