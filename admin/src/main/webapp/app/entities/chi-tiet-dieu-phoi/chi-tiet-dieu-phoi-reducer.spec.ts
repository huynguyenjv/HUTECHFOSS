...
import reducer, {
  ...
  reset,
  updateEntity,
} from './chi-tiet-dieu-phoi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHITIETDIEUPHOI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHITIETDIEUPHOI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHITIETDIEUPHOI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHITIETDIEUPHOI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHITIETDIEUPHOI actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHITIETDIEUPHOI actions', async () => {
      const arg = 42666;
