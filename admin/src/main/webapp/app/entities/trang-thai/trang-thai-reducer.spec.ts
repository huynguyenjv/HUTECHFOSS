...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANGTHAI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANGTHAI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANGTHAI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRANGTHAI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANGTHAI actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANGTHAI actions', async () => {
      const arg = 42666;
