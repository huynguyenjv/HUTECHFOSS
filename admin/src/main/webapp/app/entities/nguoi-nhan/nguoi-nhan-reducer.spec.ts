...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NGUOINHAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NGUOINHAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NGUOINHAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NGUOINHAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NGUOINHAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NGUOINHAN actions', async () => {
      const arg = 42666;
