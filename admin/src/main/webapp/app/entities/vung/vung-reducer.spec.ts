...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './vung.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VUNG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VUNG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VUNG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VUNG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VUNG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VUNG actions', async () => {
      const arg = 42666;
